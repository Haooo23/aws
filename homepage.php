...
<body>
    <div class="container">
        <h1 class="mt-5">Docker Project Setup</h1>

        <h2 class="mt-4">Step 1 — Create a Nginx Container</h2>
        <ol>
  ...
  nginx:
    ...
    ports:
      - 80:80</code></pre></li>
        ...
        <h2 class="mt-4">Step 2 — Create a PHP Container</h2>
        <ol>
...
docker-compose up -d</code></pre></li>
        ...
        <h2 class="mt-4">Step 3 — Create a MariaDB Container</h2>
        <ol>
